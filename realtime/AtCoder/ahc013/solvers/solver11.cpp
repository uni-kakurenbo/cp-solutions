    ...
    while((clock() - start) * 1000 < TIME_LIMIT_MS * CLOCKS_PER_SEC) {
        ...
        for(int i=0; i<l; ++i) {
            ...
            for(int j=0; j<Alpha; ++j) {
                ...
                if(score > score_min) {
                    buffer.emplace_back(score, cnt, res);
                }
            }
        }

        sort(buffer.begin(), buffer.end(), [](State &a, State &b) { return a.score == b.score ? a.gen < b.gen : a.score > b.score; });
