...
struct Board {
  ...
  public:
    ...
    bool find_rectangles(const int px, const int py, set<Rectangle> *found) const {
        ...
        for(int d=0; d<8; ++d) {
            ...
            if(
                ...
                if(tx2 == gx0 && ty2 == gy0) {
                    ...
                    if(tx3 == px && ty3 == py ) {
                        ...
                        found->emplace(px, py, tx0, ty0, tx10, ty10, tx2, ty2);
                    }
                }
            }
            ...
            if(
                ...
                if(tx2 == gx1 && ty2 == gy1) {
                    ...
                    if(tx3 == px && ty3 == py ) {
                        already.emplace(tx2, ty2);
                        found->emplace(px, py, tx0, ty0, tx11, ty11, tx2, ty2);
                    }
                }
            }
        }
    ...
    while(true) {
        ...
        for (int i=0; i<times; ++i) {
            ...
            for(const Rectangle& rectangle : found) {
                ...
                buffer.emplace_back(score, next_board);
            }
        }
        // debug(buffer);
