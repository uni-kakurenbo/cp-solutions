...
signed main() {
    ...
    REP(i, LENGTH) {
        ...
        Score max_score_0 = -1; int max_dir_0 = -1;
        ...
        ITR(dir0, DIR) {
            ...
            Score max_score_1 = -1;
            ITR(dir1, DIR) {
                Score temp_score_1 = 0;
                REP(pos1, LENGTH) {
                    auto temp_box_1 = temp_box_0;
                    if(temp_box_1.get(pos1) >= 0) continue;
                    temp_box_1.put(pos1, fs[i+1]);
                    temp_box_1.tilt(dir1);
                    temp_score_1 += evaluator.evaluate(temp_box_1);
                }
                if(max_score_1 < temp_score_1) max_score_1 = temp_score_1;
            }

            if(max_score_0 < max_score_1) {
                max_score_0 = max_score_1;
                max_dir_0 = dir0;
                next_box_0 = move(temp_box_0);
            }
        }
        curr_box = move(next_box_0);
        cout << DIRCTIONS[max_dir_0] << endl;
        debug(curr_box);
    }
