...
struct Solver {
    ...
    static inline size_t BASIC_WIDTH(const Position N) { return 2 * pow(61.0 / N, 8.15714246814); }
    static inline Position BASIC_SEARCH_RANGE(const Position N) { return N / 4; }
    ...
    Score solve(vector<Rectangle> *answer) const {
        ...
        const auto basic_search_range = BASIC_SEARCH_RANGE(N);
